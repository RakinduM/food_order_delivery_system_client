...
const OrderCard: React.FC<OrderCardProps> = ({
  ...
  return <div className="bg-gray-900 rounded-lg p-4 mb-4 shadow-md cursor-pointer" onClick={handleCardClick}>
      ...
      {showActions && <div className="flex mt-4 space-x-2">
          <button onClick={handleAccept} className="flex-1 bg-green-500 text-black font-medium py-2 rounded-lg">
            Accept
          </button>
          <button onClick={handleReject} className="flex-1 bg-gray-700 text-white font-medium py-2 rounded-lg">
            Decline
          </button>
        </div>}
    </div>;
